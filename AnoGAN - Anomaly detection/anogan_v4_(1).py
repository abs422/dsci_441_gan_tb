...
# model_d.load_weights('./checkpoints/discriminator.h5')
# model_g.load_weights('./checkpoints/generator.h5')
...
tb = healthy_tb[healthy_tb['patient'] == 'unhealthy']
plt.hist(sick['0'],  color = 'r', rwidth = 0.5)
plt.hist(healthy['0'],  color = 'b', rwidth = 0.6)
